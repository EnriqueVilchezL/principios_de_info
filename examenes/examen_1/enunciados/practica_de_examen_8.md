...
Debe implementar al menos **3 funciones** en un módulo de código morse y distribuir de forma balanceada las tareas. **Utilice variables globales para modelar el estado del módulo, como el mensaje original y decodificado**. Cree como variable global además un diccionario que traduzca entre letras/números a código morse, y otro que haga la operación contraria.
